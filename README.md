...
This app runs on Windows and is designed for users without any programming skills. You don’t need to write code or use command lines. Just download, install, and start using Beta-Claw.
...
## 🚀 Getting Started: How to Download and Run Beta-Claw
...
1. Click “New Agent” to create your first AI agent.  
2. Choose a provider from the list (like OpenAI).  
3. Enter a task or question in the prompt box.  
4. Click “Run” to get your AI response.  
...
- Verify you are downloading the `.exe` file from the official release page.  
...
### Can Beta-Claw run on Mac or Linux?
